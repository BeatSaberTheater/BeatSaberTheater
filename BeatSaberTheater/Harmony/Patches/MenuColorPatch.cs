...
public class MenuColorPatch
{
    ...
    public static void Postfix(MenuLightsPresetSO preset)
    {
        ...
        if (preset != null && preset.lightIdColorPairs != null && preset.lightIdColorPairs.Length > 0 &&
            preset.lightIdColorPairs[0] != null)
        {
...
public class FallbackColorPatch
{
    ...
    {
        if (__instance._defaultPreset != null && __instance._defaultPreset.lightIdColorPairs != null &&
            __instance._defaultPreset.lightIdColorPairs.Length > 0 &&
            __instance._defaultPreset.lightIdColorPairs[0] != null)
