...
public class CurvedSurface : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Math.Abs(_distance - distance) < 0.01f) return;
    ...
    private void UpdateRadius()
    {
        ...
        if (_curvatureDegreesFixed != null || !_config.CurvedScreen)
        {
    ...
    private float GetCircleFraction()
    {
        ...
        if (CurvatureDegrees > 0) circleFraction = 360f / CurvatureDegrees;
    ...
    private MeshData CreateSurface()
    {
        ...
        for (i = j = 0; i < _subsurfaceCount + 1; i++)
        {
            ...
            if (i >= _subsurfaceCount) continue;
