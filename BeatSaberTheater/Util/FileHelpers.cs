...
public static class FileHelpers
{
    ...
    public static string SecondsToString(int seconds)
    {
        ...
        if (seconds > 60 * 60) return timeSpan.Hours + ":" + $"{timeSpan.Minutes:00}" + ":" + $"{timeSpan.Seconds:00}";
    ...
    public static string ShortenFilename(string path, string s)
    {
        ...
        if (allowedLength >= s.Length) return s;
    ...
    public static bool IsInEditor()
    {
        ...
        for (var i = 0; i < SceneManager.sceneCount; i++)
        {
            ...
            if (sceneName != "BeatmapLevelEditorWorldUi" && sceneName != "BeatmapEditor3D") continue;
    ...
    public static string GetEnvironmentName()
    {
        ...
        {
            var sceneName = SceneManager.GetSceneAt(i).name;
            if (!sceneName.EndsWith("Environment")) continue;
    ...
    public static string GetHardwareInfo()
    {
        ...
        try
        {
            ...
            info.Add("System Language: " +
                     (Application.systemLanguage == SystemLanguage.English ? "English" : "Other"));
        }
        catch (Exception e)
        {
            Plugin.Log.Error(e);
